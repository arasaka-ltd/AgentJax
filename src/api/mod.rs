...
pub use methods::{
    ...
    ScheduleUpdateRequest, SessionCancelRequest, SessionGetRequest, SessionGetResponse,
    SessionListItem, SessionListResponse, SessionMessage, SessionMessageAnnotation,
    SessionMessageKind, SessionMessageMeta, SessionSendRequest, SessionSendResponse,
